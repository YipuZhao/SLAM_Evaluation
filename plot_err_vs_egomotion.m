...
% gf_slam_list = {'Test4_40percent';}
track_type = {'AllFrame'; 'KeyFrame';};
seq_list = {'02'; '06'; '07'; '08'; '09';}; % {'08'}; %
do_viz = 1;
round_num_list = {10, 10, 10, 9, 10};
...
for gn = 1 : length(gf_slam_list)
    ...
    orig_slam_path = ['/mnt/DATA/GoogleDrive/ORB_SLAM/KITTI_POSE_REF_SLAM/Test3']
