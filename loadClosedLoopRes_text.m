      ...
      if plot_gf
        ...
        for fn = 1:length(Number_GF_List)
          ...
          [err_nav_gf{sn, vn, fn}, err_est_gf{sn, vn, fn}, ~] = ...
            processClosedLoopText(data_dir, Seq_Name_List{sn}, imu_type, 'GF_gpu_skf', ...'GF_skf', ...
      ...
      if plot_gg
        ...
        for fn = 1:length(Number_GF_List)
          ...
          [err_nav_gg{sn, vn, fn}, err_est_gg{sn, vn, fn}, ~] = ...
            processClosedLoopText(data_dir, Seq_Name_List{sn}, imu_type, 'GF_GG_skf_gpu', ...'GF_GG_skf', ...
            Prefix, Number_GF_List(fn), Fwd_Vel_List(vn), rn, ...
            err_nav_gg{sn, vn, fn}, err_est_gg{sn, vn, fn});
