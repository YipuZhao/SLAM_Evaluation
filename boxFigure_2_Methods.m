function boxFigure_2_Methods(lmk_ratio_list, track_loss_ratio, round_num, ...
  stat_type, err_orig, err_gf, legend_arr)
...
[err_summ] = boxPlot_2_Methods(lmk_ratio_list, track_loss_ratio, round_num, ...
  'term_drift', stat_type, err_orig, err_gf, legend_arr, whisker_val);
% legend(legend_arr);
set(gca, 'YScale', 'log');
...
[err_summ] = boxPlot_2_Methods(lmk_ratio_list, track_loss_ratio, round_num, ...
  'term_orient', stat_type, err_orig, err_gf, legend_arr, whisker_val);
% legend(legend_arr);
set(gca, 'YScale', 'log');
xlabel('Ratio of lmk selected');
...
[err_summ] = boxPlot_2_Methods(lmk_ratio_list, track_loss_ratio, round_num, ...
  'rel_drift', stat_type, err_orig, err_gf, legend_arr, whisker_val);
% legend(legend_arr);
set(gca, 'YScale', 'log');
xlabel('Ratio of lmk selected');
...
[err_summ] = boxPlot_2_Methods(lmk_ratio_list, track_loss_ratio, round_num, ...
  'rel_orient', stat_type, err_orig, err_gf, legend_arr, whisker_val);
% legend(legend_arr);
set(gca, 'YScale', 'log');
xlabel('Ratio of lmk selected');
...
[err_summ] = boxPlot_2_Methods(lmk_ratio_list, track_loss_ratio, round_num, ...
  'track_perc', stat_type, err_orig, err_gf, legend_arr, whisker_val, 0);
% legend(legend_arr);
set(gca, 'YScale', 'log');
xlabel('Ratio of lmk selected');
